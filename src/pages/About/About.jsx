...
import authorImg from '../../assets/Images/Author/about.png'
    ...
    return (
        <div className="hero min-h-screen">
            <div data-aos="fade-up" className="hero-content flex-col lg:flex-row">
                <img src={authorImg} className="max-w-xl rounded-lg shadow-xl" />
                <div data-aos="fade-left" className='ms-24'>
                    <h1 className="text-5xl font-bold mb-1">Zabaidul Islam.</h1>
                    ...
                    <Link to='/contact'><button className="border-2 px-7 py-2 bg-[#35495E] text-white hover:bg-[#2B3A49] hover:text-[#FFFFFF]  transition-colors duration-300 transform hover:scale-105 me-28 mt-2">Contact</button></Link>
                </div>
            </div>
        </div>
    );
