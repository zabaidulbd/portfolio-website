...
const Connect = () => {
    ...
    return (
        <div className='flex justify-end'>
            ...
            <button onClick={() => scroll.scrollToTop({ duration: 500, smooth: true })} className='btn btn-square bg-[#35495E] text-white font-bold hover:bg-gray-800 transition-colors duration-300 transform hover:scale-105 mt-auto me-3'><FaRegArrowAltCircleUp className=''></FaRegArrowAltCircleUp>Top</button>
        </div>
    );
};
